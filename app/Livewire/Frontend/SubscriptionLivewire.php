...
class SubscriptionLivewire extends Component
{
    ...
    {
        return view('frontend.subscription')->layout('frontend.layout.app');
    }

    public function getDiet(){
        $this->diet_list = DietType::whereJsonContains('goal', $this->goalData)->get();
        $plan_ids = FoodPricing::where('goal', $this->goalData)->pluck('plan')->unique()->toArray();
        $this->plan_list = FoodPlan::whereIn('id', $plan_ids)->get();
    }

    public function getPrice(){
        $price_data = FoodPricing::where('plan', $this->planData)->where('goal', $this->goalData)->first();
    ...
    public function submitData(){
        $subscription = new FoodSubscription;
        ...
        $planDetail = FoodPricing::where('plan', $this->planData)->where('goal', $this->goalData)->first();
