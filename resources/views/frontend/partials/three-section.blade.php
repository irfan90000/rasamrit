<section class="py-5 text-center" style="background-color: #e9fdf3;">
    <div class="container">
        <h2 class="fw-bold" style="color: #1e7b3e;">How it Works?</h2>
        ...
        <div class="d-flex justify-content-center">
            <div class="d-flex align-items-center gap-2">
                <a href="#" class="btn fw-bold rounded-pill px-4 py-2 bg-success text-white" >
                    Free Call With Nutritionist
                </a>
                <span class="d-inline-flex align-items-center justify-content-center rounded-circle bg-warning text-white" style="width: 40px; height: 40px;">
      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
           class="bi bi-arrow-up-right" viewBox="0 0 16 16">
        <path fill-rule="evenodd"
              d="M6.364 13.364a.5.5 0 0 0 .707 0L13 7.435V11.5a.5.5 0 0 0 1 0v-6a.5.5 0 0 0-.5-.5h-6a.5.5 0 0 0 0 1h4.065l-5.93 5.929a.5.5 0 0 0 0 .707z" />
      </svg>
    </span>
            </div>
        </div>
