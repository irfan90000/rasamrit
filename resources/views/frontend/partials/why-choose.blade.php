...
{{--        <!-- Heading -->--}}
{{--        <div class="text-center mb-5">--}}
{{--            <h2 class="fw-bold text-success display-6">Why Choose Rasamrit?</h2>--}}
{{--            <h5 class="text-muted fw-normal fs-5">How We’re Different — And Better</h5>--}}
{{--            <p class="mt-3 text-secondary fs-6 mx-auto" style="max-width: 700px;">--}}
{{--                Rasamrit isn’t just a meal plan, it’s a lifestyle upgrade. We believe healthy eating should be affordable for everyone, without compromising on quality, freshness, or results.--}}
{{--            </p>--}}
{{--        </div>--}}
