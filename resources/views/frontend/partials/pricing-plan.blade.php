                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="card h-100 border-0 shadow rounded-4 bg-white">
                        <div class="card-body d-flex flex-column align-items-center text-center px-4 py-5">
                            ...
                            <p class="fw-bold text-price mb-3">
                                {{ $plan['price'] }}
                            ...
                            @if ($plan['price'] === 'Custom')
                                {{-- Last (Custom) → Call Link --}}
                                <a href="tel:+917204490402"
                                   class="fw-semibold text-white text-decoration-none py-2 px-4 rounded-pill subs_btn animated slideInLeft d-inline-block">
                                    Select Plan
                                </a>
                            @else
                                {{-- First 3 → Food Pricing Page --}}
                                <a href="/food-pricing"
                                   class="fw-semibold text-white text-decoration-none py-2 px-4 rounded-pill subs_btn animated slideInLeft d-inline-block">
                                    Select Plan
                                </a>
