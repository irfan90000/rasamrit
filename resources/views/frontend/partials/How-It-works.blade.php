...
<section class="">
    <div class="container">
        <div class="text-center wow fadeInUp">
            <h2 class="section-intro-title">#HOWITWORKS</h2>
            <p class="section-title">1 Lakh Plus Happy Customers Served</p>
        </div>
        <div class="row gy-5 gx-4 mb-5">
            ...
            <div class="col-lg-4 wow fadeInUp">
                <div class="d-flex aign-items-center text-center h-100">
                    <img class="img-fluid object-contain" src="{{ asset('frontend/img/work.png') }}" alt="work">
                </div>
            </div>
            <div class="col-lg-4 wow fadeInUp">
                <div class="row g-3">
            ...
            <div class="col-lg-7 wow fadeInUp">
                <div class="slide_card">
                    @foreach ($goal_list as $goal)
                        <div class="img_card">
                            <span>{{ $goal->name }}</span>
                            <img src="{{ asset('storage/goal/' . $goal->image) }}" class="img-fluid" alt="work" />
                        </div>
                    @endforeach
                </div>
            </div>
