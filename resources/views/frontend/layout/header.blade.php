            ...
            <div class="navbar-nav ms-auto">
                <a href="{{ route('front.index') }}"
                   class="{{ Route::is('front.index') || Route::is('front.contact') ||
                    Route::is('front.terms') || Route::is('front.privacy') ? 'active' : '' }} nav-item nav-link ">
                    Home
                </a>
                <a href="{{ route('front.pricing') }}"
                   class="nav-link {{ Route::is('front.pricing') ? 'active' : '' }}">
                    Pricing</a>
                <a href="{{ route('front.subscription') }}"
                   class="nav-link {{ Route::is('front.subscription') ? 'active' : '' }}">
                    Food Subscription
                </a>
                ...
                <a href="{{ route('front.coaching') }}"
                   class="nav-link {{ Route::is('front.coaching') ? 'active' : '' }}">
                    Online Coaching
                </a>
