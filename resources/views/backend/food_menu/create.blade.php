        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('admin.food-menu.store') }}">
                            @csrf
                            <div class="row g-3">
                                <div class="col-lg-6">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <select class="form-select @error('dietary') is-invalid @enderror" name="dietary">
                                        ...
                                        <option value="nonvegetarian">Non
                                            Vegetarian</option>
                                                    ...
                                                    <div class="row g-3">
                                                        ...
                                                        <div class="col-lg-12">
                                                            ...
                                                            <textarea rows="4" class="form-control" name="breakfast[{{ $i }}][description]"
                                                                id="breakfast_description_{{ $i }}" placeholder="Enter Description" required></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="row g-3">
                                                        ...
                                                        <div class="col-lg-12">
                                                            ...
                                                            <textarea rows="4" class="form-control" name="lunch[{{ $i }}][description]"
                                                                id="lunch_description_{{ $i }}" placeholder="Enter Description" required></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="row g-3">
                                                        ...
                                                        <div class="col-lg-12">
                                                            ...
                                                            <textarea rows="4" class="form-control" name="snack[{{ $i }}][description]"
                                                                id="snack_description_{{ $i }}" placeholder="Enter Description" required></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="row g-3">
                                                        ...
                                                        <div class="col-lg-12">
                                                            ...
                                                            <textarea rows="4" class="form-control" name="dinner[{{ $i }}][description]"
                                                                id="dinner_description_{{ $i }}" placeholder="Enter Description" required></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
