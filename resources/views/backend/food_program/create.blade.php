        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-4 text-end">
                                <a href="{{ route('admin.food-pricing.index') }}" class="btn btn-danger btn-sm">
                                    Cancel
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('admin.food-pricing.store') }}">
                            @csrf
                            <div class="row g-2">
                                <div class="col-lg-6">
                                                    ...
                                                    <div class="row g-2">
                                                        <div class="col-lg-6">
                                                            ...
                                                            <input type="number" class="form-control"
                                                                name="breakfast[{{ $i }}][price]"
                                                                id="breakfast_{{ $i }}" required
