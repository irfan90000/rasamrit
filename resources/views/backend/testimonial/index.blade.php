        ...
        <div class="row g-3">
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex align-items-center text-dark py-2">
                            <i class='bx bx-user-voice fs-4 me-1'></i>
                                ...
                                <tbody>
                                    @foreach ($testimonial_list as $key => $item)
                                        <tr>
                                            <td>{{ $key + 1 }}</td>
                                            <td>
                                                <img src="{{ asset('storage/testimonial/' . $item->image) }}"
            ...
            <div class="col-lg-4">
                <div class="card">
                    <div class="card-header">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-4 text-end">
                                @if (isset($edit_data))
                                    <a href="{{ route('admin.testimonial.index') }}" class="btn btn-danger btn-sm">
                                        Cancel
                                    </a>
                                @endif
                            </div>
                    ...
                    <div class="card-body">
                        @if (isset($edit_data))
                            <form method="post" action="{{ route('admin.testimonial.update', $edit_data->id) }}"
                            ...
                            <div class="row gy-3">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    @if (isset($edit_data) && $edit_data->image)
                                        <img src="{{ asset('storage/testimonial/' . $edit_data->image) }}" alt="User Image"
